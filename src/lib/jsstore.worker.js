  ...
  (function (modules) {
    ...
    [
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _keystore_index__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(8);
        /* harmony import */

        var _drop_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
        /* harmony import */

        var _helpers_index__WEBPACK_IMPORTED_MODULE_3__ =
        ...
        var IdbHelper =
          ...
          (function () {
            ...
            IdbHelper.getTable = function (tableName) {
              var currentTable = IdbHelper.activeDb.tables.find(function (
                table,
              ) {
            ...
            ValueChecker.prototype.checkAndModifyColumnValue_ = function (
              ...
              if (column.autoIncrement) {
                ...
                if (isNull(columnValue)) {
                  this.value[column.name] = ++this.autoIncrementValue[
                    column.name
                  ];
                } else {
                  if (
        ...
        var set_logic_Set =
          ...
          (function (_super) {
            ...
            Set.prototype.execute = function () {
              ...
              (function () {
                var cursorRequest = _this.objectStore
                  .index(query_executor_QueryExecutor.columnName)
                  .openCursor(
                    IDBKeyRange.only(
                      _this.query[query_executor_QueryExecutor.columnName],
                    ),
                  );
          ...
          (function (_super) {
            ...
            InitDb.prototype.execute = function (tablesMetaData) {
              ...
              dbRequest.onsuccess = function () {
                ...
                _this.dbConnection.onversionchange =
                  _this.onDbVersionChange.bind(_this);
                  ...
                  try {
                    ...
                    item.columns.forEach(function (column) {
                      if (column.enableSearch === true) {
                        ...
                        var keyPath =
                          column.keyPath == null ? column.name : column.keyPath;
                    ...
                    instance[
                      ...
                      'JsStore_' + _this.dbName + '_' + item.name + '_Version',
                      item.version,
                    );
                  } catch (e) {
                    console.error(e);
          ...
          (function () {
            ...
            TableHelper.prototype.setRequireDelete_ = function (dbName) {
              ...
              instance[
                ...
                .get('JsStore_' + dbName + '_' + this.name + '_Version')
            ...
            TableHelper.prototype.setDbVersion_ = function (dbName) {
              ...
              instance[
                ...
                .set(
                  'JsStore_' + dbName + '_' + this.name + '_Version',
                  idb_helper[
                    'a'
                    /* IdbHelper */
                  ].activeDbVersion,
            ...
            DbHelper.prototype.createMetaData = function () {
              ...
              return Object(
                ...
                this.tables.map(function (table) {
                  return new table_helper_TableHelper(table).createMetaData(
                    _this.dbName,
                  );
                }),
              );
        ...
        var Column =
          ...
          (function () {
            return function (key) {
              this.name = key.name;
              this.autoIncrement =
                key.autoIncrement != null ? key.autoIncrement : false;
              ...
              this.enableSearch =
                key.enableSearch == null ? true : key.enableSearch;
            ...
            QueryExecutor.prototype.processCreateDb = function (db) {
              ...
              return Object(
                ...
                dbHelper.createMetaData().then(function (tablesMetaData) {
                  _this.activeDb_ = db;
                  var createDbInstance = new init_db_InitDb(function (
                    isDbCreated,
                  ) {
                    _this.activeDb_ = db;
              ...
              if (dataBase == null) {
                ...
                this.getDbVersion_(dataBase.name)
                  .then(function (version) {
                    ...
                    _this
                      .processCreateDb(new database_DataBase(dataBase))
                      .then(onSuccess)
                      .catch(onError);
                  })
                  .catch(onError);
            ...
            GroupByHelper.prototype.executeAggregateGroupBy = function () {
              ...
              if (aggregateQry.avg) {
                if (
                  ...
                  for (index in datas) {
                    var sumForAvg =
                        datas[index]['sum(' + aggregateQry.avg + ')'],
                      countForAvg =
                    ...
                    for (var column in aggregateQry.avg) {
                      ...
                      if (isCountTypeString) {
                        if (aggregateQry.count !== avgColumn) {
                          ...
                          aggregateQry.count.indexOf(avgColumn) === -1
                        ) {
                          delete datas[index]['count(' + avgColumn + ')'];
                        }
                      }
                        ...
                        this_1.results.sort(function (a, b) {
                          if (a[prevOrderQueryBy_1] === b[prevOrderQueryBy_1]) {
                            return orderMethod_2(
                              a[currentorderQueryBy_1],
                              b[currentorderQueryBy_1],
                            );
                          }
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _helpers_index__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(14);
            ...
            DropDb.prototype.deleteMetaData = function () {
              ...
              return Object(
                ...
                _keystore_index__WEBPACK_IMPORTED_MODULE_1__[
                  /* KeyStore */
                  'a'
                ].remove('JsStore_' + _this.dbName + '_Db_Version');
                ...
                _this.activeDb.tables.forEach(function (table) {
                  _keystore_index__WEBPACK_IMPORTED_MODULE_1__[
                    ...
                    'JsStore_' + _this.dbName + '_' + table.name + '_Version',
                  );
                ...
                _this.getDbList().then(function (dbList) {
                  ...
                  _this.setDbList(dbList).then(function () {
                    ...
                    _keystore_index__WEBPACK_IMPORTED_MODULE_1__[
                      ...
                      .remove('JsStore_' + _this.dbName + '_Schema')
                      .then(res)
                      .catch(rej);
                  });
                });
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _business_index__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(3);
        /* harmony import */

        var _business_index__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(7);
        /* harmony import */

        var _keystore_index__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(8);
        /* harmony import */
        ...
        var _query_executor__WEBPACK_IMPORTED_MODULE_5__ =
            ...
            keys.map(function (columnName) {
              ...
              if (
                ...
                _business_index__WEBPACK_IMPORTED_MODULE_1__[
                  /* QueryHelper */
                  'a'
                ].autoIncrementValues[table.name][columnName] = value;
              }
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _helpers_index__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(15);
        /* harmony import */
        ...
        var _query_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
            ...
            Where.prototype.executeWhereLogic = function (column, value, op) {
              ...
              if (
                ...
                initCursorAndFilter = function () {
                  cursorRequest = _this.objectStore
                    .index(column)
                    .openCursor(_this.getKeyRange(value, op));
                ...
                if (cursor) {
                  try {
                    var cursorUpdateRequest = cursor.update(
                      updateValue(_this.query.set, cursor.value),
                    );
          ...
          (function (_super) {
            ...
            Join.prototype.checkJoinQuery_ = function (jointblInfo, qry) {
              ...
              tableSchemaOf1stTable.columns.every(function (column) {
                var columnFound = tableSchemaOf2ndTable.columns.find(function (
                  q,
                ) {
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _select_index__WEBPACK_IMPORTED_MODULE_2__ =
        ...
        var _insert_index__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(26);
        /* harmony import */

        var _remove_index__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(28);
        /* harmony import */

        var _update_index__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(29);
        /* harmony import */

        var _query_helper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7);
        /* harmony import */

        var _log_helper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1);
        /* harmony import */

        var _helpers_index__WEBPACK_IMPORTED_MODULE_9__ =
          __webpack_require__(15);
        /* harmony import */

        var _helpers_index__WEBPACK_IMPORTED_MODULE_10__ =
          __webpack_require__(25);
        /* harmony import */

        var _helpers_index__WEBPACK_IMPORTED_MODULE_11__ =
          __webpack_require__(14);
        /* harmony import */

        var _config__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9);
                ...
                .then(function (results) {
                  results.forEach(function (result, index) {
                    _query_helper__WEBPACK_IMPORTED_MODULE_7__[
                      /* QueryHelper */
                      'a'
                    ].autoIncrementValues[_this.query.tables[index]] = result;
                  });
              ...
              return Object(
                ...
                requestQueue.map(function (request) {
                  ...
                  return new _query_helper__WEBPACK_IMPORTED_MODULE_7__[
                    /* QueryHelper */
                    'a'
                  ](request.name, request.query).checkAndModify();
                }),
              );
            };
