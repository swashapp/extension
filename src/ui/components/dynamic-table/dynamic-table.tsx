...
import '../../../static/css/components/dynamic-table.css';
...
export function DynamicTable({
  ...
  return (
    <>
      {loading ? (
        <div className={'flex center dynamic-table-loading'}>
        ...
        <>
          ...
          >
            ...
            >
              <TableHead className={'dynamic-table-header'}>
                <TableRow>
                  {columns.map((col) => (
                    <TableCell
                      key={col}
              ...
              <TableBody className={'dynamic-table-body'}>
          ...
          <div
            className={
              'flex row align-center justify-between dynamic-table-pagination'
            }
          >
            <TablePagination
              className={'dynamic-table-row-per-page'}
              component={'div'}
              count={total}
            ...
            />
            <Pagination
              className={'dynamic-table-pagination-pages'}
