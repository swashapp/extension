...
function App(): ReactNode {
    ...
    return Array.from({ length: 10 }, (_, index) => index).map((id) => {
      if (id in sites) {
        ...
        return (
          ...
          >
            <img src={"/images/shape/plus.png"} alt={"add"} />
          </div>
        );
      }
    });
  ...
  return (
    ...
    >
      ...
      >
        <div className={clsx("flex align-center gap14", styles.action)}>
          <div className={"pointer"}>
            <img
              src={"/images/icons/new-tab/swash.svg"}
              alt={""}
              onClick={async () => {
          ...
          <div className={"pointer"}>
            <img
              src={"/images/icons/new-tab/page.svg"}
              alt={""}
              onClick={async () => {
          ...
          <div className={"pointer"}>
            <img
              src={"/images/icons/new-tab/eye.svg"}
              alt={""}
              onClick={() => {
                setHide(!hide);
              }}
          ...
          <div className={"pointer"}>
            <img src={"/images/icons/new-tab/line.svg"} alt={""} />
          </div>
          <div
          ...
          >
            <img src={"/images/icons/new-tab/window.svg"} alt={""} />
            <p>Customize</p>
          </div>
        </div>
        {image && ads !== "full" ? (
      ...
      <div className={clsx("flex center border", styles.row2)}>
