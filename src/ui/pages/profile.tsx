    ...
    <>
      ...
      <div className={"flex gap32"}>
        ...
        <div className={"flex col col-10 gap32"}>
          {VerificationBannerItems.map(({ text, image, verified }, index) => (
            <PunchedBox
              className={clsx(
                "card38",
                styles.banner,
                styles[account.is_verified ? "verified" : "unverified"],
                {
                  hide: verified === account.is_verified,
                },
              )}
