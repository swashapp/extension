      ...
      <div className={"flex col gap32"}>
        <div className={"flex row gap32"}>
          <NumericSection
            ...
            image={"/images/icons/swash-bonus.svg"}
          />
          <NumericSection
            className={"col-10"}
            ...
            image={"/images/icons/swash-friends.svg"}
          />
        </div>
        <div className={"round no-overflow flex nowrap gap32 bg-white card28"}>
          <div className={"flex col col-21 gap32"}>
            ...
            <div className={"flex nowrap gap16"}>
              ...
              >
                <IconButton image={"/images/logos/x.png"} />
              </TwitterShareButton>
              <FacebookShareButton
                className={"col-10"}
                url={summary.default_link?.code || ""}
                title={referralMessage}
              >
                <IconButton image={"/images/logos/facebook.png"} />
              </FacebookShareButton>
              <LinkedinShareButton
                className={"col-10"}
                url={summary.default_link?.code || ""}
              ...
              >
                <IconButton image={"/images/logos/linkedin.png"} />
              </LinkedinShareButton>
              <EmailShareButton
                className={"col-10"}
                url={summary.default_link?.code || ""}
              ...
              >
                <IconButton image={"/images/logos/email.png"} />
              </EmailShareButton>
            </div>
          </div>
          <PunchedBox
