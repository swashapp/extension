...
import '../../static/css/components/onboarding.css';
...
export function Onboarding(): ReactNode {
  ...
  return (
    ...
    >
      <div className={'no-overflow onboarding-container'}>
        <div className={'flex col onboarding-stepper'}>
          <div
            className={
              'flex justify-between border-box onboarding-header-footer'
            }
          >
            <SwashLogo />
            <div className={'flex align-center onboarding-progress'}>
              <p className={'smaller bold'}>{padWithZero(page)}</p>
              <MobileStepper
                className={'border-box onboarding-progress-bar'}
                variant={'progress'}
                steps={pages.length}
                position={'static'}
                activeStep={page}
          ...
          <div className={'flex col center onboarding-swiper-container'}>
            <MultiPageView ref={ref} onChange={setPage}>
              {pages.map((page: OnboardingPages, index: number) => (
                <div key={`page-${index}`} className={'onboarding-card'}>
          ...
          <div
            className={
              'flex justify-center border-box onboarding-header-footer'
            }
          >
