...
import close from 'url:../statics/images/close.svg';
import menu from 'url:../statics/images/menu.svg';
import SwashBanner from 'url:../statics/images/swash-banner.svg';
import Logo from 'url:../statics/images/Swash.svg';
  ...
  componentDidMount() {
    window.helper.load().then((db) => {
      this.setState({
        ...
        isEnabled: db.configs.is_enabled,
      });
    });
  }
  ...
  render() {
    return (
      <div id="swash-sidebar-navigation-mobile">
        <div className="box-upper m-0 p-0">
          <div className="col-12 m-0 p-0">
            <img
              src={SwashBanner}
              alt="Swash Banner"
              className="swash-banner"
            />
          </div>
          <div className="col-6 m-0 p-0 float-left">
            <div
              className="swash-mobile-menu-icon-wrapper"
              onClick={this.toggleClass}
            >
              <img
                src={menu}
                className="swash-mobile-menu-icon"
                alt={'Menu'}
              ></img>
            </div>
          </div>
        ...
        <div
          id="omega"
          className={this.state.active ? 'omega-activated' : null}
        >
            ...
            <div id="omega-sidebar-header" className="">
              <div className="sidbar-header-row">
                <img
                  src={Logo}
                  alt="Swash Logo"
                  className="swash-sidebar-logo-mobile"
                />
              </div>
              <div className="swash-sidbar-header-row">
                ...
                <div style={{ float: 'left', width: '50%' }}>
                  <div
                    className="swash-mobile-menu-close-icon"
                    onClick={this.toggleClass}
                  >
              ...
              <div
                ...
                className={
                  this.props.location.pathname === '/Wallet'
                    ? 'swash-sidebar-menu-active'
                    : 'swash-sidebar-menu-normal'
                }
              >
                Wallet
              </div>
