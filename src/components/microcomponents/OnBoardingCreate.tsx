...
class OnBoardingNewPage extends React.Component {
  ...
  constructor(props) {
    ...
    this.LoadOnBoardingCreateWallet =
      this.LoadOnBoardingCreateWallet.bind(this);
        ...
        <React.Fragment>
          <div className="swash-onboarding-box">
            ...
            <div className="swash-onboarding-box-body">
              ...
              <p>
                Keep the private keys in a safe place. You can share your wallet
                address <b>but never share your private keys! 🔐</b>
              </p>
            </div>
            <div className="swash-onboarding-box-footer">
              ...
              <div className="swash-onboarding-box-footer-right">
                <div
                  ...
                  onClick={this.LoadOnBoardingCreateWallet}
                >
                  Create
                </div>
