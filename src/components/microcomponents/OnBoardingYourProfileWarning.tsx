        ...
        <React.Fragment>
          <div className="swash-onboarding-box">
            ...
            <div className="swash-onboarding-box-body">
              <p>
                When Swash data is sold, 70% of profits are returned back to
                you, the Swash members.
              </p>
              <p>
                Please fill in the following profile information as accurately
                as you can. This will make the Swash data quality even better
                and even more valuable, so you’ll receive more for your
                contribution.
              </p>
            </div>
