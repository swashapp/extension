...
import arrow from 'url:../../statics/images/arrow.svg';
import error from 'url:../../statics/images/error-icon.svg';
import verified from 'url:../../statics/images/verified.svg';
                ...
                {this.state.sendToMainnet ? (
                  <>
                    <a
                      ...
                      href={`https://etherscan.io/tx/${this.state.transactionId}`}
                    >
                      Etherscan
                    </a>
                  </>
                  ...
                  <>
                    <a
                      target="_blank"
                      rel="noopener noreferrer"
                      href={`https://blockscout.com/xdai/mainnet/tx/${this.state.transactionId}`}
                    >
                      Blockscout
                    </a>
                  </>
            ...
            <div className="swash-transaction-modal-body">
              <div className="swash-transaction-modal-body-left">
                ...
                <div className="swash-transaction-modal-body-text2">
                  <span className="swash-transaction-modal-body-text3">
                    {this.state.amount}
                  </span>{' '}
                  DATA
                </div>
              ...
              <div className="swash-transaction-modal-body-right">
                <div className="swash-transaction-modal-body-text1">
                  To address
                </div>
                <div className="swash-transaction-modal-body-text3">
                  {this.purgeAddress(this.state.recipient)}
                </div>
              </div>
            </div>
