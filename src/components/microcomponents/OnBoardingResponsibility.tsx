        ...
        <React.Fragment>
          <div className="swash-onboarding-box">
            ...
            <div className="swash-onboarding-box-body">
              <p>
                Keep your private key safe and don’t share it with others. If
                you lose access and haven’t backed up your wallet,
                <b> you won’t be able to access your earnings</b>. Swash won’t
                be able to recover them for you. It’s your responsibility to be
                safe and secure.
              </p>
              <div
                ...
                <div
                  className={
                    this.state.isChecked
                      ? 'swash-onboarding-proceed-button'
                      : 'swash-onboarding-proceed-disable-button'
                  }
