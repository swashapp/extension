...
import ThreeBoxImg from 'url:../../statics/images/3box.svg';
import DropboxImg from 'url:../../statics/images/dropbox.svg';
import LocalFileImg from 'url:../../statics/images/file.svg';
import GoogleDriveImg from 'url:../../statics/images/google-drive.svg';

import CustomSnackbar from '../microcomponents/CustomSnackbar';
import PassphraseModal from '../microcomponents/PassphraseModal';
...
class SettingsPage extends React.Component {
  ...
  loadSettings() {
    window.helper.load().then((db) => {
      ...
      for (const module in db.modules) {
        modules.push(db.modules[module]);
      }

      const referralLink = db.profile.user_id
      ...
      window.helper.uploadFile(request.onboarding).then((response) => {
        if (response === false)
          this.notifyRef.current.handleNotification(
            'The configuration file could not be exported',
            'error',
          );
        else
          this.notifyRef.current.handleNotification(
            'The configuration file is exported successfully',
            'success',
          );
      });
    }
            ...
            <div className="swash-col">
              <div className="swash-setting-part">
                ...
                <div className="swash-p">
                  ...
                  {this.state.reward} DATA for every friend you bring to Swash!
                  Also, if you bring the most new users in a month, you’ll
                  receive a 1000 DATA prize. Winners are announced on
                ...
                <div className="swash-transfer-row">
                  ...
                  <div
                    className="swash-referral-column"
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        this.copyToClipboard(
                          e,
                          document.getElementById('swash-referral-link'),
                        );
                        e.target.focus();
                ...
                <div className="swash-onboarding-export-div">
                  <div className="swash-onboarding-export-option">
                    ...
                    >
                      ...
                      <div className="swash-onboarding-export-button">
                        Local file
                      </div>
                    </button>
                  </div>
