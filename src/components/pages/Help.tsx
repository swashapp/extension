          ...
          <div className="swash-col">
            <div className="swash-setting-part">
              <div className="swash-p2">
                <div className="swash-head3">Table of contents</div>
                <ul>
                  <li>
                    <div onClick={() => this.goToSection('welcome')}>
                      Welcome
                    </div>
                  </li>
                  <li>
                    <div onClick={() => this.goToSection('getting-started')}>
                      Getting Started
                    </div>
                  </li>
                  <li>
                  ...
                  <ul>
                    <li>
                      <div onClick={() => this.goToSection('balance')}>
                        Balance
                      </div>
                    </li>
                    <li>
                      <div onClick={() => this.goToSection('withdrawals')}>
                        Withdrawals
                      </div>
                    </li>
                  </ul>
                  <li>
                    <div onClick={() => this.goToSection('settings')}>
                      Settings
                    </div>
                  </li>
                  <ul>
                    <li>
                      <div onClick={() => this.goToSection('invite-a-friend')}>
                        Invite a Friend
                      </div>
                    </li>
                    <li>
                      <div
                        onClick={() =>
                          this.goToSection('backup-your-wallet-settings')
                        }
                      >
                  ...
                  <ul>
                    <li>
                      <div onClick={() => this.goToSection('text-masking')}>
                        Text Masking
                      </div>
                    </li>
                    <li>
                      <div onClick={() => this.goToSection('your-data')}>
                        Your Data
                      </div>
                    </li>
                  </ul>
                  <li>
                    <div onClick={() => this.goToSection('useful-links')}>
                      Useful Links
                    </div>
                  </li>
                </ul>
              ...
              <div className="swash-head2">
                💥 Welcome to the world’s first digital Data Union! 💥
              </div>
              <div className="swash-p">
                <div className="swash-p2">
                  You are now part of a game-changing movement to create a
                  better internet.
                  <br />
                  <br />
                  Before you dive in, make sure you get the latest updates by
                  joining the chat on{' '}
                ...
                solution that makes it possible for you to monetise your surfing
                data. Simply install, browse, and earn - that’s it. Swash does
                all the rest for you and rewards you for the value of your data.
                <br />
                <br />
                The current ecosystem doesn’t acknowledge that, without people,
                the digital economy wouldn’t exist. A small number of companies
                enjoy the profits that are created by collecting, using, and
                selling our data in shady ways without any consequences.
                <br />
                <br />
                Until now.
                <br />
                <br />
                By redistributing 70% of profits back to the people (yes, you!),
                Swash aims to rebalance and set new standards for the data
                economy.
                <br />
                <br />
                It makes it possible to easily crowdsource and crowdsell your
                data as you surf. Cool, huh?
                <br />
                <br />
                Data gets more valuable as it grows. The more people who join
                Swash, the more value returned to you and everyone else in the
                Swash Data Union.
                <br />
                <br />
                In this section, you’ll find a walkthrough of each feature
                within the Swash extension. If you have any questions, check out
                the
                <a
                  target={'_blank'}
                  rel={'noopener noreferrer'}
              ...
              <div className="swash-p2">
                ...
                <br />
                <br />
                Within the extension, you’ll see four options; <em>
                  Wallet
                </em>, <em>Settings</em>, <em>Data</em>, and <em>Help</em>.
              </div>
              ...
              <div className="swash-p2">
                ...
                <ol>
                  ...
                  <li>
                    ...
                    'Add Token' button. You can find the DATA Token Contract
                    Address{' '}
