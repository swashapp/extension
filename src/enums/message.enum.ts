export enum SystemMessage {
  ...
  FAILED_CLOUD_ACCESS_TOKEN = "Failed to get OAuth access token. Please try again",
  ...
  FAILED_TAB_INJECT_SCRIPT = "Failed to inject the script into the tab",
  ...
  INVALID_LINK_FORMAT = "Link format is not valid",
